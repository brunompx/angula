...
func ProductForm(categories []model.Category, isAddingProducs bool) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		if isAddingProducs {
			_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString("<form class=\"box\" hx-post=\"/products\" hx-swap=\"afterbegin\" hx-target=\"#product-list\"><div class=\"field\"><label class=\"label\">Category</label><div class=\"select\"><select id=\"category\" name=\"category\">")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			for _, category := range categories {
				...
				templ_7745c5c3_Var2, templ_7745c5c3_Err = templ.JoinStringErrs(category.IDS())
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `components/product_form.templ`, Line: 22, Col: 62}
				}
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `components/product_form.templ`, Line: 22, Col: 80}
				}
